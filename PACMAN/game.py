...
class Game:
    ...
    def run( self ):
        ...
        while not self.gameOver:
            ...
            visited_states.add(self.state)
            visited_states_list_all.append(self.state)
            # count_for_each_visited_state[self.state] += 1
            ...
            if _BOINC_ENABLED:
                hello = boinc.set_fraction_done(self.getProgress())
                # print("hello")
                # print(hello)
        # file2 = open("QLearningVisitedStatesCount.txt","a")
        # for i in visited_states:
        #     occurrence = {item: visited_states_list_all.count(item) for item in visited_states_list_all}
        #     file2.write("State: " + str(i))
        #     file2.write("\n")
        #     file2.write("Number of times visited: " + str(occurrence.get(i)))
        #     file2.write("\n")
        #     file2.write("+========================================================")
        # file2.close()
        ...
        for agentIndex, agent in enumerate(self.agents):
            if "final" in dir( agent ) :
                try:
                    ...
                    return
        self.display.finish()
        # file1 = open("ApproxQLearningVisitedStates.txt","a")
        # file1.write(str(len(visited_states)))
        # file1.write("\n")
        # file1.close()
        # file_da = open("count_file.txt", "a")
        # for i in visited_states_list_all:
        #     file_da.write(str(i))
        #     # file_da.write("\n")
        # file_da.close()            
